...
public class NepalATC implements AirTrafficController{
    List<Flight> flights;
    @Override
    public void registerFlight(Flight flight) {
        flight.setAirTrafficController(this);
        flights.add(flight);
        System.out.println("Flight "+flight.getFlightNumber()+" registered with Nepal ATC");
    }
    ...
    public void deregisterFlight(Flight flight) {
        ...
        System.out.println("Flight "+flight.getFlightNumber()+" deregistered with Nepal ATC");
    }
}
